      ...
      <header data-thq="thq-navbar" className="login-navbar-interactive">
        ...
        >
          <nav
            ...
            className="login-nav"
          >
            <Link to="/personal-profile" className="login-navlink1">
              For Individuals
            </Link>
            <Link to="/personal-hrms" className="login-navlink2">
              For Business
            </Link>
        ...
        <div data-thq="thq-navbar-btn-group" className="login-btn-group">
          ...
          <div data-thq="thq-dropdown" className="login-thq-dropdown list-item">
            <div
            ...
            <ul data-thq="thq-dropdown-list" className="login-dropdown-list">
              <li data-thq="thq-dropdown" className="login-personal list-item">
                <div
                  data-thq="thq-dropdown-toggle"
                  className="login-dropdown-toggle1"
                >
                  <Link to="/personal-signup" className="login-personal1">
                    Personal
                  </Link>
                </div>
              </li>
              <li data-thq="thq-dropdown" className="login-business list-item">
                <div
                  data-thq="thq-dropdown-toggle"
                  className="login-dropdown-toggle2"
                >
                  <Link to="/business-signup" className="login-business1">
                    Business
                  </Link>
                </div>
              </li>
        ...
        <div data-thq="thq-mobile-menu" className="login-mobile-menu">
          ...
          >
            <div className="login-container1">
              ...
              <div data-thq="thq-close-menu" className="login-menu-close">
                <svg viewBox="0 0 1024 1024" className="login-icon04">
          ...
          <div className="login-icon-group">
            <svg viewBox="0 0 950.8571428571428 1024" className="login-icon06">
            ...
            <svg viewBox="0 0 877.7142857142857 1024" className="login-icon08">
            ...
            <svg viewBox="0 0 602.2582857142856 1024" className="login-icon10">
          ...
          <form name="personal-signup-form" className="login-form">
            ...
            <div id="userType" className="login-container3">
              <div className="login-container4">
                <input
                  type="radio"
                  name="radio"
                  className="login-radiobutton"
                />
                <input
                  type="radio"
                  name="radio"
                  className="login-radiobutton1"
                />
              </div>
            ...
            <div className="login-container6">
              <div className="login-container7">
                <label className="login-lblusername">Username:</label>
                <input
                  type="text"
                  required
                  placeholder="Username / Email / Phone"
                  autoComplete="given-name"
                  className="login-inusername input"
                />
                <label className="login-lblpassword">Password</label>
                <input
                  type="password"
                  required
                  placeholder="Password"
                  autoComplete="family-name"
                  className="login-inpassword input"
                />
              </div>
            </div>
